...
function createConfigSpreadsheet() {
  ...
  const basicData = [
    ['項目名', '値'],
    ['会社名', 'AIメタバース'],
    ['Chat Webhook URL', 'https://chat.googleapis.com/v1/spaces/AAQALk4O9Cw/messages?key=AIzaSyDdI0hCZtE6vySjMm-WEfRq3CPzqKqqsHI&token=99zolQoNt6nfpnjnXWOXfA7iBvzRQAFT6jBI_IVu7ww'],
    ['応募管理シート名', '求人応募管理シート'],
    ['追加メッセージ', '面談者:カンゲン&EFチーム \n 経験者: https://timerex.net/s/t.ito_336d_9fda/20abba8b \n 未経験者: https://timerex.net/s/y.matsumoto_9445_6a5c/80d340a1']
  ];
  ...
  // デフォルトの求人サイト設定
  const siteData = [
    ['マイナビ', 'mt.customer@mynavi.jp', '応募受付', '・応募者への連絡は、応募管理システムMIWSの「応募管理」または「メッセージ」をご利用ください。', '応募データの詳細は、下記手順にてご確認ください。', 'dga66', 'AImetaverse@'],
    ['type', 'noreply@notification.type.jp', '話を聞きたい応募がありました', '新しい「話を聞きたい応募」がありましたので、お知らせいたします。', '応募者とのやり取りは「即レスポンス」が大切です。', '', ''],
    ['type', 'noreply@notification.type.jp', '応募がありました', '新しい応募がありましたので、お知らせいたします。', '応募者とのやり取りは「即レスポンス」が大切です。', '', ''],
    ['EN転職', 'support@employment.en-japan.com', '新着応募のお知らせ', '下記URLより、応募者の詳細情報をご確認ください。', '※ 応募者対応の早さは、貴社の採用活動を有利にします。', 'ENS669427', 'AImetaverse@2'],
    ['エンゲージ', 'system@en-gage.net', '新着応募のお知らせ', '下記URLより、応募内容をご確認の上、ご対応をお願いします。', 'ご不明点は、', '', ''],
    ['doda', 'connect@doda.jp', '応募通知', '窓口：doda窓口', '--本件に関するお問い合わせ先---------------------', 'recruit@ai-metaverse.jp', 'AImetaverse@1'],
    ['TypeDirect', 'cl-info@directtype.jp', '新着の応募', '新着の応募またはメッセージが届いていますのでご確認お願いいたします。', 'ＮＧの場合であっても、必ずご返信いただきますようお願い申し上げます。', '46750/recruit@ai-metaverse.jp', 'AImetaverse@'],
    ['TypeDirect', 'cl-info@directtype.jp', '応募者対応のお願い', '引き続きご対応をお願いしたく、改めてご連絡を差し上げております。', '※ログインができないなどご不明点がございましたら、', '46750/recruit@ai-metaverse.jp', 'AImetaverse@']
  ];
